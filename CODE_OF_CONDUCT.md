...
We as members, contributors, and leaders pledge to make participation in the `skseed`
...
skseed exists to collide ideas hard: to build the strongest version of a claim, then the
strongest counter-argument, and keep only what survives. **Argue with the claim, never
with the person.** An adversarial review of an idea is exactly what this project is for.
An adversarial posture toward a contributor is not, and is a Code of Conduct violation
regardless of how correct the underlying technical point turns out to be.

The same discipline applies to the collider's own output. A truth grade or coherence score
is a model's judgement about a proposition. It is never evidence about a person, and
citing one to characterize a contributor is unacceptable.
...
community leaders responsible for enforcement (smilinTux / SKWorld) via the contact
address on the GitHub organization profile, or through GitHub's own reporting tools on
[`smilinTux/skseed`](https://github.com/smilinTux/skseed).

All complaints will be reviewed and investigated promptly and fairly. All community
leaders are obligated to respect the privacy and security of the reporter of any incident.

**Note:** this channel is for conduct reports. Security vulnerabilities go through the
private process in [SECURITY.md](SECURITY.md) instead, never through a public issue.
